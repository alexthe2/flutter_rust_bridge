...
class FlutterRustBridgeExampleSingleBlockTestWasmModule implements WasmModule {
  ...
  external dynamic /* void */ wire_get_app_settings_in_result(NativePortType port_);

  external dynamic /* void */ wire_get_vector_of_app_settings(NativePortType port_, int count);
}
...
class FlutterRustBridgeExampleSingleBlockTestWire
  ...
  void wire_get_app_settings_in_result(NativePortType port_) => wasmModule.wire_get_app_settings_in_result(port_);

  void wire_get_vector_of_app_settings(NativePortType port_, int count) =>
      wasmModule.wire_get_vector_of_app_settings(port_, count);
}
