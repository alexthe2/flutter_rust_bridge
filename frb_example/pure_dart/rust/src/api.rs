...
pub fn get_app_settings_in_result() -> anyhow::Result<ApplicationSettings> {
    Ok(external_lib::get_app_settings())
}

// pub fn get_vector_of_app_settings_no_result(count: usize) -> Vec<ApplicationSettings> {
//     (0..count)
//         .map(|_| external_lib::get_app_settings())
//         .collect()
// }

pub fn get_vector_of_app_settings(count: usize) -> anyhow::Result<Vec<ApplicationSettings>> {
    Ok((0..count)
        .map(|_| external_lib::get_app_settings())
        .collect())
}

// pub fn get_vector_of_app_settings_in_option(
//     count: usize,
// ) -> anyhow::Result<Option<Vec<ApplicationSettings>>> {
//     Ok(Some(
//         (0..count)
//             .map(|_| external_lib::get_app_settings())
//             .collect(),
...
// pub fn get_vector_of_app_settings_in_option_no_result(
//     count: usize,
// ) -> Option<Vec<ApplicationSettings>> {
//     Some(
//         (0..count)
//             .map(|_| external_lib::get_app_settings())
//             .collect(),
